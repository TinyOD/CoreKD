...
class RFLA_FCOSHead(AnchorFreeHead):
    ...
    def loss(self,
        ...
        # bbox_scores = flatten_cls_scores[:, gt_labels].detach()
        # print('gt_labels:', gt_labels)
        # print('gt_labels:', gt_labels, type(gt_labels), gt_labels[0], type(gt_labels[0]))
        # print('bbox_scores:', bbox_scores.shape)
    ...
    def get_targets(self, points, gt_bboxes_list, gt_labels_list):
        ...
        # print('gt_bboxes_list:', gt_bboxes_list[0].shape)
